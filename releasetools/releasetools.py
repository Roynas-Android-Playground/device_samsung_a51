...
def OTA_Assertions(info):
  ...
  if m:
    ...
    cmd = ('assert(a51.verify_bootloader_min("{}") == "1" || abort("ERROR: This package requires OneUI 5 based firmware. Please upgrade firmware and retry!"););').format(bootloader_version)
